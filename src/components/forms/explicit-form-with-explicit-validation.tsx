...
const ExplicitFormWithExplicitValidation = () => {
  ...
  return (
    <>
      <form onSubmit={customHandleSubmit} onReset={formikForm.handleReset}>
        <div className="row">
          <div className="col-6">
...
export default ExplicitFormWithExplicitValidation;
